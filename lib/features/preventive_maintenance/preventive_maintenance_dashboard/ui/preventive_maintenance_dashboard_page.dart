...
class PreventiveMaintenanceDashboardPage
    extends GetView<PreventiveMaintenanceDashboardController> {
  const PreventiveMaintenanceDashboardPage({super.key});
...
class _GradientHeader extends GetView<PreventiveMaintenanceDashboardController>
    implements PreferredSizeWidget {
  const _GradientHeader();

  @override
  PreventiveMaintenanceDashboardController get controller =>
      Get.find<PreventiveMaintenanceDashboardController>();
...
class _CalendarCard extends GetView<PreventiveMaintenanceDashboardController> {
  const _CalendarCard();
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  order.durationLine, // "4H required"
                  style: const TextStyle(
                    fontSize: 13,
                    color: Colors.black87,
                    fontWeight: FontWeight.w600,
...
class _Tabs extends GetView<PreventiveMaintenanceDashboardController> {
  const _Tabs();
